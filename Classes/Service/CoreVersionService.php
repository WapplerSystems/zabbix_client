...
namespace WapplerSystems\ZabbixClient\Service;

use TYPO3\CMS\Core\Utility\GeneralUtility;
use TYPO3\CMS\Core\Utility\VersionNumberUtility;
use TYPO3\CMS\Install\Service\Exception\RemoteFetchException;
use WapplerSystems\ZabbixClient\Utility\CoreVersion\CoreRelease;
use WapplerSystems\ZabbixClient\Utility\CoreVersion\MaintenanceWindow;
use WapplerSystems\ZabbixClient\Utility\CoreVersion\MajorRelease;
...
class CoreVersionService
{
    ...
    {
        [$explodedVersion] = explode('.', $this->getInstalledVersion());
        return (string)(int)$explodedVersion;
    }
